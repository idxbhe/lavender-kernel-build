...
This document is for archival reference only and is no longer maintained. Since KernelSU v1.0, we have dropped official support for non-GKI devices.
...
<!-- Tab labels: exec.c | open.c | read_write.c | stat.c -->
